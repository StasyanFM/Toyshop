...
// Класс для отслеживания веса игрушек и назначает отностиельный шанс в текущем розыгрыше, разыгрывает игрушки по списку участников
...
public class Raffle {
    ...
    class QuantityCalc {
        ...
        @param t // выинранная игрушка
        @param tl //список игрушек в текущем розыгрыше
        @return
